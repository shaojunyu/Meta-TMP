...
option_list <- list(
  ...
  make_option(c("-o", "--outfile"), type="character", default='MCODE_network.html', help="Output Network [default %default]")
)
...
cluster_out <- cluster(network, method = "MCODE", plot = FALSE)
