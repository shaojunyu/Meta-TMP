...
# Last update: 2015-06-16, Shi Huang, Xiaoquan Su, Gongchao Jing
#################################################################
...
option_list <- list(  
  ...
  make_option(c("-P", "--Paired"), type="logical",default=FALSE,help="If paired samples [Optional, default %default]"),
