...
# Last update: 2015-06-08, Xiaoquan Su, Chao Li
#################################################################
...
# paramenter checking
if(is.null(opts$dist_file)) stop('Please check the input file.')
...
plot(g, layout=layout.fruchterman.reingold,main=str,edge.label=E(g)$weight)
