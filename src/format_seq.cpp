...
int printhelp(){
    ...
    cout << "Format-Seq: " << Version << endl;
    cout << "Usage : format-seq [Options] Value" << endl;
    cout << "\toption : " << endl;
    cout << "\t-i Input sequence file in FASTA or FASTQ format [Conflict with -l]" << endl;
    cout << "\t-l Input sequence file list [Conflict with -i]" << endl;
    cout << "\t-p List file path prefix for '-l' [Optional]" << endl;
   // cout << "\t-o Result outfilename , default is Out.fa" << endl;
    cout << "\t-h Help" << endl;
